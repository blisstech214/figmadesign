...
function Login() {
  ...
  return (
    <div>
      <div className="flex  items-center py-5 justify-center space-x-4 md:space-x-3">
        <img src={logo} alt="Logo" className="h-6 w-auto md:h-9 ml-2" />
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full bg-bgcolor max-w-md  shadow-lg p-4 sm:p-6">
          <h1 className="text-lg sm:text-xl text-black font-bold text-center mb-2">
            maak een gratis account aan met je mailadres en verifieer je
            mailadres
          </h1>
