        ...
        <div className="bg-bgcolor p-3 sm:p-5 md:p-10 space-y-5">
          ...
          <div className="flex justify-around items-center">
            <div className="flex justify-center items-center gap-2">
              ...
              <span className="w-5 h-5 text-white bg-orangedark flex items-center justify-center rounded-full">1</span>
            </div>
            <h1 className="text-sm sm:text-lg text-zinc-400">gisteren</h1>
            <h1 className="text-lg sm:text-xl text-orangedark font-bold" onClick={() => setCurrentPage("filters")}>
              <FiFilter />
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            {/* Second Card */}
            <div className="bg-white space-y-3 p-3 sm:p-5 border-2 rounded-xl" onClick={() => setCurrentPage("pageTwo")}>
              <div className="flex justify-between items-center">
                <div>
                  <h1 className="text-sm sm:text-base md:text-xl font-bold text-orangedark">belangrijke facturen</h1>
            ...
            {/* Third Card */}
            <div className="bg-white space-y-3 p-3 sm:p-5 border-2 rounded-xl" onClick={() => setCurrentPage("inbox")}>
              <div className="flex justify-between items-center">
                <div>
                  <h1 className="text-sm sm:text-base md:text-xl font-bold text-orangedark">belangrijke aankopen</h1>
                  <h1 className="text-xs sm:text-sm md:text-base text-gray-300">
                    je factuurbox is de eerste Gratis conversie facturen
                  </h1>
                </div>
              ...
              <p className="md:text-lg list-none font-medium text-xs sm:text-sm flex justify-between items-center">
                ...
                <li className="text-black font-bold">houten balken<br />138*38mm</li>
            ...
            {/* Fourth Card */}
            <div className="bg-white space-y-3 p-3 sm:p-5 border-2 rounded-xl" onClick={() => setCurrentPage("outbox")}>
              <div className="flex justify-between items-center">
                <div>
                  <h1 className="text-sm sm:text-base md:text-xl font-bold text-orangedark">jouw projecten</h1>
                  <h1 className="text-xs sm:text-sm md:text-base text-gray-300">
                    je factuurbox is de eerste Gratis conversie facturen
                  </h1>
                </div>
