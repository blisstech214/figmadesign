        ...
        <div className="bg-white p-5 space-y-3">
          <div className="flex justify-between py-6">
            <h1 className="font-bold text-lg">
              Overzicht meest betaalde aankopen 
            </h1>
          ...
          {products.map((product, index) => (
            <div
              key={product.id}
              className="flex justify-between items-center mb-4 md:mb-0 text-xs md:text-sm lg:text-lg font-medium"
            >
              {index === 0 ? (
          ...
          {/* Add space between product list and pagination */}
          <div className="">
